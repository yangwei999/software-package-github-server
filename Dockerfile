...
COPY softwarepkg/infrastructure/codeimpl/download.py /opt/app/download.py
RUN chmod +x /opt/app/code.sh && apk update && apk add --no-cache git libc6-compat rpm curl python3 py3-pip
